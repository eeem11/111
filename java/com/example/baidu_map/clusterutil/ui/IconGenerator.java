...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        mContext = context;
        mContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.map_cluster_icon, null);
        // 直接使用根视图作为 RotationLayout
        mRotationLayout = (RotationLayout) mContainer;
    ...
    private static int getTextStyle(int style) {
        switch (style) {
            ...
            case STYLE_DEFAULT:
            case STYLE_WHITE:
                return R.style.Base_Theme_MyApplication;
            case STYLE_RED:
            case STYLE_BLUE:
            case STYLE_GREEN:
            case STYLE_PURPLE:
